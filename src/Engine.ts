namespace MainProgram{
  ...
  export let m3 = {
    ...
    myProjection: function(width : any, height : any, depth : any) {
      // Note: This matrix flips the Y axis so 0 is at the top.
      return [
         2 / width, 0, 0, 0,
         0, 2 / height, 0, 0,
    ...
    export class Engine{
        ...
        constructor()
        {
            ...
            if (glContext) {
                ...
                glContext.depthFunc(glContext.LEQUAL);                                // определяет работу буфера глубины: более ближние объекты перекрывают дальние
        ...
        public DrawScence (currentCameraPosition : any) : void
        {
          ...
          let translation = [0, 0,-30];
          let rotationInRadians = -30;
          let scale = [1, 1];
          ...
          /*if(currentCameraPosition == null)
            ...
            matrix = m3.multiply(matrix, m3.translation(currentCameraPosition[0], currentCameraPosition[1], currentCameraPosition[2]));
         */
          console.log(matrix)
          // Set the matrix.
        ...
        public DrawPlane(definition : any) : void
        {
            ...
            // Compute the matrix
            var aspect = glContext.canvas.width / glContext.canvas.height;
            var zNear = 1;
            var zFar = 2000;
            ...
            let scale = [1, 1];
            let fieldOfViewRadians = degToRad(30);
            //let matrix = m3.projection(this._canvas.clientWidth, this._canvas.clientHeight);
            //matrix = m3.translate(matrix, translation[0], translation[1]);
            //matrix = m3.rotate(matrix, rotationInRadians);
            //matrix = m3.scale(matrix, scale[0], scale[1]);
            
            //let matrix = m3.perspective(fieldOfViewRadians,aspect,zNear,zFar);
            //matrix = m3.multiply(matrix, m3.yRotation(90));
            ...
            if(definition == null)
              ...
              matrix = m3.multiply(matrix, m3.translation(definition[0], definition[1], definition[2]));
